...
macro_rules! column_provider_iface {
    ($iface_init_fn:ident, $get_columns_fn:ident, $rust_provider:ident, $set_rust_provider:ident) => {
        ...
        pub unsafe extern "C" fn $iface_init_fn(iface: gpointer, _: gpointer) {
            use crate::nautilus4_ffi::NautilusColumnProviderIface;
        ...
        pub unsafe extern "C" fn $get_columns_fn(_provider: gpointer) -> *mut GList {
            use crate::glib_ffi::g_list_append;
            use crate::nautilus4_ffi::nautilus_column_new;
            use libc::c_void;
            use std::ffi::CString;
            use std::ptr;
        ...
        static $rust_provider: LazyLock<Mutex<Option<Box<dyn ColumnProvider>>>> =
